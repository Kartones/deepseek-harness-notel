...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/session/session-telemetry-disabled': { kind: 'none', reason: 'The inert backend drops seam records and registers nothing model-facing.' },
  ...
  'packages/identity/session-anonymous-user-id': { kind: 'none', reason: 'The pure in-memory session-id map makes no model calls and registers nothing model-facing.' },
