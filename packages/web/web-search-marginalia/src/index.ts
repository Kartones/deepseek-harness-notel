...
export const WEB_SEARCH_MARGINALIA_SETTINGS_NAMESPACE = 'web-search-marginalia'
...
export function apply(ctx: Context, config: Config): void {
  ...
  ctx.inject(['settings'], (settingsCtx) => {
    settingsCtx.settings.installSection(ctx, WEB_SEARCH_MARGINALIA_SETTINGS_NAMESPACE, Config, config, {
      setSource: (source) => {
        current = source
      },
      onChange: () => {},
