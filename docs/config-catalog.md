...
- `@deepseek-ai/dsh-command-feedback-local` — requires `commands` ([`packages/feedback/command-feedback-local/src/index.ts`](../packages/feedback/command-feedback-local/src/index.ts))
